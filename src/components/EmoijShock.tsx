...
const EmojiShock: React.FC<EmojiProps> = (props) => {
  return (
    <Svg 
      viewBox="0 0 800 800" 
    ...
    >
      <Defs>
        <RadialGradient id="b" r="93%" cx="20%" cy="20%">
          <Stop offset="70%" stopColor="hsl(115, 100%, 84%)" stopOpacity={0} />
          <Stop offset="97%" stopColor="#82cb7d" />
        </RadialGradient>
        <RadialGradient id="c" r="65%" cx="28%" cy="20%">
          <Stop offset="0%" stopColor="#e8ffdf" stopOpacity={0.75} />
          <Stop offset="100%" stopColor="hsl(115, 100%, 84%)" stopOpacity={0} />
        </RadialGradient>
