...
const EmojiNeutral: React.FC<EmojiProps> = (props) => {
  return (
    <Svg 
      viewBox="0 0 800 800"
    ...
    >
      <Defs>
        <RadialGradient id="b" r="93%" cx="20%" cy="20%">
          ...
          <Stop offset="97%" stopColor="#c89924" />
        </RadialGradient>
      ...
      <G strokeLinecap="round">
        ...
        <Path
          ...
          fill="url(#c)"
        />
        <Ellipse rx={23.5} ry={25} cx={350} cy={375} />
        <Ellipse
          rx={23.5}
          ry={25}
          cx={350}
          ...
          fill="url(#e)"
        />
        <Ellipse rx={23.5} ry={25} cx={450} cy={375} />
        <Ellipse
          rx={23.5}
          ry={25}
          cx={450}
